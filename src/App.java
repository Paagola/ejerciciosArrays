    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (eleccion) {
            ...
            case 4: // EJERCICIO 4
                ...
                for (int i = 0; i < num4.length; i++) {
                    System.out.printf(
                            num4[i] + "%" + ((arrays.contarNumeros(num4[i]) == espacios1) ? 1 : espacios1) + "s| ",
                            " ");
                    System.out.printf(num42[i] + "%"
                            + ((arrays.contarNumeros(num42[i]) != espacios2)
                                    ? (arrays.contarNumeros(num42[i]) == 2) ? 2 : 3
                                    : espacios2 - 2)
                            + "s| ", " ");
            ...
            case 13: // EJERCICIO 13
                ...
                switch (min_max) {
                    ...
                    default:
                        System.out.println("Elección no perimitada, lo sentimos.");
                        break;
            ...
            case 14: // EJERCICIO 14
                ...
                System.out.println("Introduce palabra y colores:");
            ...
            case 15: // EJERCICIO 15
                int[] mesas = arrays.crearArrayRandom(10, 0, 4);

                correcto = true;
                int nuevos = 0;
                do {
                    arrays.imprimirTabla(mesas);
                    nuevos = Integer.parseInt(
                            System.console().readLine("\n¿Cuántos son? (Introduzca -1 para salir del programa): "));
                    if (nuevos > -1) {
                        int num_mesa = arrays.mesaIndicada(mesas, nuevos);

                        if (num_mesa == -1) {
                            System.out.println("Lo sentimos, acutalmente no hay mesas disponibles.");
                        } else if (mesas[num_mesa] != 0) {
                            System.out.println(
                                    "Tendrán que compartir mesa. Por favor, sientense en la mesa número " + num_mesa);
                            mesas[num_mesa] = mesas[num_mesa] + nuevos;
                        }

                        else {
                            System.out.println("Por favor, sientense en la mesa número " + num_mesa);
                            mesas[num_mesa] = mesas[num_mesa] + nuevos;
                        }
